...
import { agentExecutorRoutes } from "./routes/agent-executor.js";
...
export async function createApp(
  ...
  api.use(researchRoutes(db, opts.researchConfig));
  ...
  api.use("/internal/agent-executor", agentExecutorRoutes());
  app.use("/api", api);
